# VoiceTyper - 바이브코딩할 때 쓰는 음성타이쥑 프로그램
...
단축키를 누르고 말하메, 음성을 인식하여 커서 위치에 텍스트를 자동 입력합니다.

- **ꂄ편한 사용** - 단축키(Right Ctrl)를 누르고 있는 동안 녹음, 떼면 자동 입력
...
`VoiceTyper.exe`를 다운로드하여 실행하메 됩니다. 별도 설치 과정이 없습니다.
